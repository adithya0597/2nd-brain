...
Query SQLite for 30-60 days of journal entries:
```sql
...
Also get attention scores for all Key Elements:
```sql
...
Query to get mention distribution:
```sql
...
### 4. Compare Intentions vs Behavior
