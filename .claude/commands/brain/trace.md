...
**Input:** `$ARGUMENTS` — the concept name or topic to trace

## Steps

### 1. Identify the Concept
The concept to trace is: `$ARGUMENTS`

If no argument provided, list recent concepts from SQLite:
```sql
...
### 3. Query SQLite for Structured Data
