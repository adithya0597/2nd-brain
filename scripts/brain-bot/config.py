...
DIMENSION_KEYWORDS = {
    ...
    "Mind & Growth": ["learn", "read", "book", "course", "study", "skill", "research", "education", "mindset", "philosophy", "psychology", "self improvement", "self-improvement", "personal growth", "online course", "leetcode", "prepping", "prep", "practicing"],
