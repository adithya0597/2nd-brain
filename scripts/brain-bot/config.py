...
DIMENSION_KEYWORDS = {
    "Health & Vitality": ["health", "fitness", "workout", "diet", "sleep", "exercise", "nutrition", "meditation", "yoga", "running", "run", "gym", "weight", "mental health", "work out", "working out", "well-being", "wellbeing", "calorie", "stretch", "whoop", "blood pressure", "checkup", "sodium", "meal prep", "macros", "personal best", "5k", "pushups", "squats", "pull ups"],
    "Wealth & Finance": ["money", "finance", "invest", "portfolio", "budget", "savings", "income", "expense", "crypto", "stocks", "salary", "debt", "tax", "side hustle", "net worth", "credit card", "bank account", "real estate", "applying for jobs", "apply for jobs", "linkedin outreach", "job search", "job hunt", "job scrapping", "job fit", "job portals", "pitch deck", "recruiter", "outreach program", "reach out to people", "wells fargo", "callbacks", "negotiated salary", "signing bonus", "new offer", "rent", "linkedin", "round of interview", "demo video", "reached out", "data engineering roles"],
    "Relationships": ["friend", "family", "relationship", "dating", "partner", "social", "colleague", "hang out", "hanging out", "catch up", "catching up", "get together", "mom", "dad", "parents", "siblings", "buddy", "college buddy"],
    "Mind & Growth": ["learn", "read", "reading", "book", "course", "study", "skill", "research", "education", "mindset", "philosophy", "psychology", "self improvement", "self-improvement", "personal growth", "online course", "leetcode", "practicing", "implement", "studying"],
    "Purpose & Impact": ["mission", "purpose", "impact", "contribute", "volunteer", "leadership", "legacy", "meaning", "values", "give back", "side project", "open source", "passion project", "mentoring", "mentor", "blog post", "thought leadership", "food bank", "community center"],
    "Systems & Environment": ["automate", "automation", "tool", "setup", "organize", "clean", "home", "workspace", "routine", "habit", "workflow", "set up", "setting up", "clean up", "cleaning up", "time management", "webapp", "dashboard", "infrastructure", "nodes", "cosine similarity", "mathematical functions", "folder structure", "template", "rsync", "cron", "automated backup", "swarm of agents", "judging agent", "multi-agent", "second brain", "2nd brain", "obsidian vault", "semantic", "keyword analysis"],
}
