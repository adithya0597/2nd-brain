...
DIMENSION_KEYWORDS = {
    ...
    "Systems & Environment": ["system", "automate", "tool", "setup", "organize", "clean", "home", "workspace", "routine", "habit", "process", "workflow", "set up", "setting up", "clean up", "cleaning up", "time management", "webapp", "dashboard", "infrastructure", "nodes", "cosine similarity", "mathematical functions", "folder structure", "template", "rsync", "cron", "automated backup", "swarm of agents", "judging agent", "multi-agent"],
}
